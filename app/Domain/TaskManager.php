...
class TaskManager
{
    ...
    public function saveTask(array $requestData, User $creator): void
    {
        $status = $this->statusRepository->getStatus((int)$requestData['status_id']);
        $this->taskRepository->store($creator, $requestData, $status);
    }
